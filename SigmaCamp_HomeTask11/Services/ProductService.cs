            ...
            switch (typeOfProduct)
            {
                case 'm':
                    ...
                    if (meatDescription.Length == 4)
                    {
                        ...
                        {
                            storage.AddItem(new Meat(price, weight, meatDescription[2], meatDescription[3]));
                        }
                    }
                    else
                    {
                ...
                case 'o':
                    ...
                    if (productDescription.Length == 3)
                    {
                        ...
                        {
                            storage.AddItem(new Product(productDescription[0], price, weight));
                        }
                    }
                    else
                    {
                ...
                case 'd':
                    ...
                    if (dairyProductDescription.Length == 4)
                    {
                        ...
                        {
                            storage.AddItem(new DairyProducts(dairyProductDescription[0], price, weight, shelfLife));
                        }
                    }
                    else
                    {
